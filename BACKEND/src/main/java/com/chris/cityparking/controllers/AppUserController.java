...
public class AppUserController {
    ...
    // a refresh token request for user
...
/**
 * The class will deal with login request from a user
 * refresh of token after expiry time of the previous
 */